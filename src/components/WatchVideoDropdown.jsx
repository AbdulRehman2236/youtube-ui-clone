    ...
    <div className="flex flex-col absolute py-4 bg-white border border-gray-100 rounded-2xl w-32 mt-11">
      <ul className="flex flex-col gap-1">
        <li className="flex px-4 hover:bg-gray-200 p-1">
          ...
          <p className="text-sm text-slate-800">Clip</p>
        </li>
        <li className="flex px-4 hover:bg-gray-200 p-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="text-sm text-slate-800">Save</p>
        </li>
        <li className="flex px-4 hover:bg-gray-200 p-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="text-sm text-slate-800">Report</p>
        </li>
      </ul>
    </div>
  );
...
export default WatchVideoDropdown;
